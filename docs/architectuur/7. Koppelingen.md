...
Dit zijn groepen velden zoals NAW-gegevens of bankgegevens met een voorgedefinieerde naam (code) en type. Een plug-in kan in zijn definitie bepaalde veldgroepen vereisen om te functioneren. Hierdoor
kan de plug-in broncode rechtstreeks naar deze velden verwijzen en is er de garantie dat het veld bestaat en van
een bepaald type is. Bij het
