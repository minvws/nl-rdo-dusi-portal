...
ALTER TABLE public.application_stage_transitions ADD CONSTRAINT "application_stage_transitions_application_id_foreign" FOREIGN KEY ("application_id") REFERENCES public.applications ("id");
ALTER TABLE public.application_stage_transitions ADD CONSTRAINT "application_stage_transitions_subsidy_stage_transition_id_foreign" FOREIGN KEY ("subsidy_stage_transition_id") REFERENCES public.subsidy_stage_transitions ("id");
ALTER TABLE public.application_stage_transitions ADD CONSTRAINT "application_stage_transitions_previous_application_stage_id_foreign" FOREIGN KEY ("previous_application_stage_id") REFERENCES public.application_stages ("id");
ALTER TABLE public.application_stage_transitions ADD CONSTRAINT "application_stage_transitions_new_application_stage_id_foreign" FOREIGN KEY ("new_application_stage_id") REFERENCES public.application_stages ("id");
ALTER TABLE public.application_stage_transitions ADD CONSTRAINT "application_stage_transitions_application_id_previous_application_stage_id_unique" unique ("application_id", "previous_application_stage_id");
ALTER TABLE public.application_stage_transitions ADD PRIMARY KEY ("id");

ALTER TABLE public.subsidy_stage_transitions ADD COLUMN "description" varchar(200) NULL;

ALTER TABLE public.application_messages ADD COLUMN "application_stage_transition_id" uuid NULL;
ALTER TABLE public.application_messages ADD CONSTRAINT "application_messages_application_stage_transition_id_foreign" FOREIGN KEY ("application_stage_transition_id") REFERENCES public.application_stage_transitions ("id");
ALTER TABLE public.application_messages ADD CONSTRAINT "application_messages_application_stage_transition_id_unique" unique ("application_stage_transition_id");
...
ALTER TABLE public.subsidy_stage_transitions ALTER COLUMN "description" SET NOT NULL ;

INSERT INTO public.application_stage_transitions (
...
SELECT
    ...
    CASE
        ...
        END,
    s.created_at
FROM public.application_stages s, public.application_stages ps, public.subsidy_stage_transitions t
...
SET application_stage_transition_id = (
    SELECT t.id
    FROM public.application_stage_transitions t
...
ALTER TABLE public.application_messages ALTER COLUMN "application_stage_transition_id" SET NOT NULL;

ALTER TABLE public.subsidy_stages ADD COLUMN "internal_note_field_code" varchar(255) NULL;

UPDATE public.subsidy_stages SET internal_note_field_code = 'firstAssessmentInternalNote' WHERE id = '8027c102-93ef-4735-ab66-97aa63b836eb';
UPDATE public.subsidy_stages SET internal_note_field_code = 'secondAssessmentInternalNote' WHERE id = '61436439-e337-4986-bc18-57138e2fab65';
UPDATE public.subsidy_stages SET internal_note_field_code = 'internalAssessmentInternalNote' WHERE id = '7ceb3c91-5c3b-4627-b9ef-a46d5fe2ed68';
UPDATE public.subsidy_stages SET internal_note_field_code = 'coordinatorImplementationInternalNote' WHERE id = '85ed726e-cdbe-444e-8d12-c56f9bed2621';
