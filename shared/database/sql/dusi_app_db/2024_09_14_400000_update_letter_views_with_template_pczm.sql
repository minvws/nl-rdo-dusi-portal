...
-- PZCM_TRANSITION_STAGE_3_TO_REJECTED_MESSAGE - 64a636d8-ed0c-4bb6-982e-f948c68755b6
...
-- PZCM_TRANSITION_STAGE_5_TO_REJECTED_MESSAGE - 7da32b2f-4f0d-44ab-bc87-07718db4bfd5
...
-- PZCM_TRANSITION_STAGE_5_TO_APPROVED_MESSAGE - 9c2ad81e-cf52-41a3-966f-fc9757de15c9
...
-- PZCM_TRANSITION_STAGE_6_TO_INCREASED_MESSAGE - d3dcc915-fdaf-472a-9f3c-d9a09dc263b3
...
{block content}
    ...
    <ul>
        <li>De financiële ondersteuning is eenmalig en telt daarom niet voor de inkomensbelasting (Box 1). Het heeft ook
            geen gevolgen voor uw WIA-uitkering. Het bedrag wordt wel onderdeel van het vermogen en kan hier belast
            worden (Box 3). Voor toeslagen, de bijstand en de eigen bijdragen voor zorg op basis van de Wet langdurige
            zorg of de Wet maatschappelijke ondersteuning 2015 wordt gekeken naar uw vermogen. Het kabinet heeft de
            financiële ondersteuning tijdelijk (voor een periode van 10 jaar) uitgezonderd voor deze vermogenstoets. Let
            op: U moet de uitzondering zelf aanvragen. Meer informatie staat bij de vragen en antwoorden op <a
                href="https://www.dus-i.nl/post-covid" target="_blank">www.dus-i.nl/post-covid</a>.
        </li>
    </ul>
{/block}
