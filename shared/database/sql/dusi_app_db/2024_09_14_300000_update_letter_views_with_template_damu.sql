-- DAMU
-- TRANSITION_STAGE_2_TO_1_MESSAGE - a9ed4e8e-932e-43cf-afb6-364ef54403e6
...
<header>
    <section id="logo">
        <img id="ribbon" style="top: -14.5mm;" src="{$content->logoStream|dataStream}"/>
        <span id="ministry">Ministerie van Onderwijs, Cultuur en Wetenschap</span>
    </section>
</header>
{/block}
...
-- TRANSITION_STAGE_3_TO_REJECTED_MESSAGE - 350d6eae-0f5e-49aa-9c80-280bcc6efafb
...
-- TRANSITION_STAGE_4_TO_APPROVED_MESSAGE - 9445db1e-2aeb-4434-be02-e57622c28e77
...
{block content}
    ...
    <p><u>Wet- en regelgeving</u><br/>
       Op deze subsidie is de volgende wet- en regelgeving van toepassing:
   </p>
    <ul>
    ...
    <p><u>Meldingsplicht</u><br/>
        U bent verplicht een melding te maken bij de Dienst Uitvoering Subsidies aan Instellingen (DUS-I) wanneer niet, niet
        op tijd of niet geheel zal worden voldaan aan de verplichtingen die aan de subsidie zijn verbonden. U doet in ieder
        geval melding als de leerling dit subsidiejaar met de opleiding stopt.
    </p>

    <p><u>Verantwoording</u><br/>
        De subsidie is direct vastgesteld. Dit betekent dat er na afloop van het subsidiejaar geen verantwoording van de
        subsidie nodig is.
    </p>

    <p><u>Wat als u zich niet aan de voorschriften houdt?</u>
        Het niet voldoen aan de verplichtingen kan tot gevolg hebben dat u de subsidie helemaal of gedeeltelijk moet
        terugbetalen.
    </p>
    ...
    <p>Ik streef ernaar het toegekende subsidiebedrag zo spoedig mogelijk naar u over te maken onder vermelding van
        het referentienummer {$content->reference}.
    </p>
{/block}
