-- Start BTV assessment field changes
                ...
                "elements": [
                    {
                        ...
                        "elements": [
                                ...
                                "elements": [
                                    {
                                        ...
                                        "elements": [
                                            {
                                                "type": "CustomControl",
                                                "scope": "#\/properties\/extractPopulationRegisterDocument",
                                                "label": "Uittreksel bevolkingsregister",
                                                "options": {
                                ...
                                "elements": [
                                    {
                                        ...
                                        "elements": [
                                            {
                                                "type": "CustomControl",
                                                "scope": "#\/properties\/proofOfMedicalTreatmentDocument",
                            ...
                            {
                                "type": "Group",
                                "label": "Medische verklaring van het type behandeling",
                                "elements": [
                                    {
                                        "type": "VerticalLayout",
                                        "elements": [
                                            {
                                                "type": "CustomControl",
                                                "scope": "#\/properties\/proofOfTypeOfMedicalTreatmentDocument",
                ...
                "elements": [
                    {
                        ...
                        "options": {
                            "fields": {
                                "Uitreksel bevolkingsregister": "{extractPopulationRegisterDocument}",
...
-- End BTV assessment field changes
