...
SET title = 'Sociaal-medische beoordeling (medische rapportage)'
WHERE code = 'socialMedicalAssessment'
                ...
                "elements": [
                    {
                        ...
                        "options": {
                            "fields": {
                                "Gewaarmerkt verzekeringsbericht": "{certifiedEmploymentDocument}"
                            }
                        }
                    }
                ]
                ...
                "elements": [
                    {
                        ...
                        "options": {
                            "fields": {
                                "WIA-Beslissing": "{wiaDecisionDocument}",
                                "WIA-Beslissing uitgesteld": "{isWiaDecisionPostponed}",
                                "Toekenningsbrief (indien uitgesteld)": "{wiaDecisionPostponedLetter}",
                                "Eerste ziektedag buiten de periode van 1 maart 2020 tot en met 31 december": "{isWiaDecisionFirstSickDayOutsidePeriod}",
                                "Bewijsstukken (eerste ziektedag buiten genoemde periode)": "{wiaFirstSickDayOutsidePeriodProof}"
                            }
                        }
                    }
                ]
                ...
                "elements": [
                    {
                        ...
                        "options": {
                            "fields": {
                                "Bewijs van dienstverband": "{employmentContract}",
                                "Functie": "{employmentFunction}",
                                "Werkgever": "{employerKind}",
                                "Verklaring zorgaanbieder (indien anders)": "{otherEmployerDeclarationFile}",
                                "Heeft u gewerkt in een justiti\u00eble inrichting?": "{hasBeenWorkingAtJudicialInstitution}",
                                "BIG-nummer": "{BIGNumberJudicialInstitution}"
                            }
                        }
                    }
                ]
                ...
                "elements": [
                    {
                        ...
                        "options": {
                            "fields": {
                                "Sociaal-medische beoordeling (medische rapportage)": "{socialMedicalAssessment}",
                                "Bevat uw medisch onderzoeksverslag de diagnose langdurige post-COVID?": "{hasPostCovidDiagnose}",
                                "Verklaring arts (indien geen diagnose)": "{doctorsCertificate}"
                            }
                        }
                    }
                ]
