...
ALTER TABLE "subsidy_stage_transitions" ADD COLUMN "description" varchar(200) NOT NULL;

ALTER TABLE "application_messages" ADD COLUMN "application_stage_transition_id" uuid NOT NULL;
...
UPDATE public.subsidy_stage_transitions SET description = 'Aanvraag gevraagd' WHERE id = '870bc38a-0d50-40a9-b49e-d56db5ead6b7';
