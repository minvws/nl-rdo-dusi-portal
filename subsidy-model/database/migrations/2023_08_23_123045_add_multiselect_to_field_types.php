...
return new class extends Migration
{
    ...
    public function down(): void
    {
        ...
        DB::statement("ALTER TABLE fields ADD CONSTRAINT fields_type_check check (\"type\" in ('text', 'text:numeric', 'text:email', 'text:tel', 'text:url', 'checkbox', 'select', 'textarea', 'upload', 'custom:postalcode', 'custom:country', 'custom:bankaccount'));");
    }
};
