...
return [
    ...
    */
    ...
    'middleware' => [
        ...
        'encrypt_cookies' => \MinVWS\DUSi\Assessment\API\Http\Middleware\EncryptCookies::class,
        'verify_csrf_token' => \MinVWS\DUSi\Assessment\API\Http\Middleware\VerifyCsrfToken::class,
    ],
