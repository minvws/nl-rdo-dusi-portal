...
Dit kan via de knop 'Create new user' op het Users overzicht.  
...
Vervolgens kan het account worden aangemaakt via 'Submit'.  
...
Ook is er een optie de gegevens af te drukken.
...
De Functioneel Beheerder is verantwoordelijk voor deze controle en voor het vastleggen dat de gegevens zijn overhandigd en het identiteitsbewijs is gecontroleerd.  
...
Dit formulier moet in tweevoud opgesteld en ondertekend worden. Een ter bewaring bij DUS-I en een voor de ontvanger als bewijs.
