...
class AssessmentFieldsSeeder extends Seeder
{
    ...
    public function firstAssessmentFields(): void
    {
        ...
        $this->createMultiSelectField(
            ...
            options:         [
                'Niet van toepassing',
                'De datum waarop de WIA-uitkering niet wordt ontvangen ligt in de periode van 1 maart 2022 tot 1 februari 2023 (104 weken wachttijd)',
            ],
            isRequired:      false,
            retentionPeriod: DataRetentionPeriod::Short
        );
    ...
    public function secondAssessmentFields(): void
    {
        ...
        $this->createCheckboxField(
            subsidyStageId:  SubsidyStagesSeeder::STAGE_3_UUID,
    ...
    public function internalAssessmentFields(): void
    {
        //Interne controle
        $this->createMultiSelectField(
            subsidyStageId:  SubsidyStagesSeeder::STAGE_4_UUID,
    ...
    public function coordinatorImplementationFields(): void
    {
        ...
        $this->createSelectField(
            subsidyStageId:  SubsidyStagesSeeder::STAGE_5_UUID,
