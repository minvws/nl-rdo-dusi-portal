...
class FieldsTableSeeder extends Seeder
{
    ...
    public function createPCZMFields(): void
    {
        ...
        $this->createUploadField(subsidyStageId: SubsidyStagesTableSeeder::PCZM_STAGE_1_UUID, code: 'bankStatement', title: 'Kopie bankafschrift',);

        $this->createUploadField(subsidyStageId: SubsidyStagesTableSeeder::PCZM_STAGE_1_UUID, code: 'extractPersonalRecordsDatabase', title: 'Uittreksel bevolkingsregister niet ouder dan 3 maanden',);

        $this->createUploadField(subsidyStageId: SubsidyStagesTableSeeder::PCZM_STAGE_1_UUID, code: 'proofOfMedicalTreatment', title: 'Verklaring behandeltraject',);

        $this->createUploadField(subsidyStageId: SubsidyStagesTableSeeder::PCZM_STAGE_1_UUID, code: 'proofOfTypeOfMedicalTreatment', title: 'Verklaring type behandeling',);
        ...
        $this->createMultiSelectField(subsidyStageId: SubsidyStagesTableSeeder::PCZM_STAGE_2_UUID, code: 'checklist', title: 'Gecontroleerd', options: [
                "Uittreksel van het BRP is opgestuurd",
                "De aanvrager is een ingezetene (> 4 maanden) in Nederland",
                "de aanvrager is ouder dan 18 jaar",
                "De verklaring van de arts over het behandeltraject is opgestuurd",
