...
class FieldsTableSeeder extends Seeder
{
    ...
    public function createBTVFields(): void
    {
        ...
        $this->createUploadField(subsidyStageId: SubsidyStagesTableSeeder::BTV_STAGE_1_UUID, code: 'bankStatement', title: 'Kopie bankafschrift', mimeTypes: ['image/*','application/pdf'], maxFileSize: 5242880);

        $this->createUploadField(subsidyStageId: SubsidyStagesTableSeeder::BTV_STAGE_1_UUID, code: 'extractPersonalRecordsDatabase', title: 'Uittreksel bevolkingsregister niet ouder dan 3 maanden', mimeTypes: ['image/*','application/pdf'], maxFileSize: 5242880);

        $this->createUploadField(subsidyStageId: SubsidyStagesTableSeeder::BTV_STAGE_1_UUID, code: 'proofOfMedicalTreatment', title: 'Verklaring behandeltraject', mimeTypes: ['image/*','application/pdf'], maxFileSize: 5242880);

        $this->createUploadField(subsidyStageId: SubsidyStagesTableSeeder::BTV_STAGE_1_UUID, code: 'proofOfTypeOfMedicalTreatment', title: 'Verklaring type behandeling', mimeTypes: ['image/*','application/pdf'], maxFileSize: 5242880);
